...
import drivewealth_logo from '../../../../attachments/logos/DW_logo.png'
      ...
      <div className={showInfo ? 'experience' : 'hideInfo'}>
        <div className="experience-list">
          {companies.map((item, index) => {
            console.log('time:', companyDetails.time)
            return (
              <div
                key={index}
                className={
                  'experience-item' +
                  (index === selectedIndex ? ' experience-selected' : '')
                }
        ...
        <div className="experience-details">
          <div className="logo-title">
            <img
              ...
              src={this.getImage(companies[selectedIndex])}
              alt="img"
            />
            <div>
              <span
